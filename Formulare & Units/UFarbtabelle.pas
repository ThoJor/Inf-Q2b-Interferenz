...
begin                                                        //Farben mit Wellenlaengen 678.37nm bis 435.01 nm
  ...
  Farben[29].Hex:='21ff00'; Farben[29].Wlaenge:= 640;
  Farben[30].Hex:='39ff00'; Farben[30].Wlaenge:= 635;
  Farben[31].Hex:='4fff00'; Farben[31].Wlaenge:= 630;
  Farben[32].Hex:='63ff00'; Farben[32].Wlaenge:= 625;
  Farben[33].Hex:='77ff00'; Farben[33].Wlaenge:= 620;
  Farben[34].Hex:='89ff00'; Farben[34].Wlaenge:= 615;
  Farben[35].Hex:='9bff00'; Farben[35].Wlaenge:= 610;
  Farben[36].Hex:='adff00'; Farben[36].Wlaenge:= 605;
  Farben[37].Hex:='beff00'; Farben[37].Wlaenge:= 600;
  Farben[38].Hex:='cfff00'; Farben[38].Wlaenge:= 595;
  Farben[39].Hex:='dfff00'; Farben[39].Wlaenge:= 590;
  Farben[40].Hex:='efff00'; Farben[40].Wlaenge:= 585;
  ...
  Farben[63].Hex:='a900ff'; Farben[63].Wlaenge:= 470;
