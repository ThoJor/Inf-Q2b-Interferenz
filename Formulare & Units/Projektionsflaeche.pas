      ...
      begin
        if posx<>0 then
          begin
            ...
            ynach:=Round(ImgIntensitaet.Height*4 div 5*(Intensitaet_Doppelspalt(a,b,e,GWellenlaenge,(posx+1)/(GDynZoom*TBZoom.Position)))/ymax);
         ...
         //   Strich_Zeichnen(ImgIntensitaet.Width div 2);
          end;
      end;
