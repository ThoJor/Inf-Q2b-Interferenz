...
begin
  ...
  begin
    Projektionsflaeche.Schirm.Picture := nil;
    Projektionsflaeche.Schirm.Canvas.Brush.Color:=clblack;
    Projektionsflaeche.Schirm.Canvas.Pen.Color:=clblack;
    Projektionsflaeche.Schirm.Canvas.Rectangle(0,0,Image1.Width,Image1.Height);
  end;

  if ChBBgWhite.Checked = True then
  begin
    Projektionsflaeche.Schirm.Picture := nil;
    Projektionsflaeche.Schirm.Canvas.Brush.Color:=clWhite;
    Projektionsflaeche.Schirm.Canvas.Pen.Color:=clWhite;
    Projektionsflaeche.Schirm.Canvas.Rectangle(0,0,Image1.Width,Image1.Height);
  end;

  if ChBBgVerlauf.Checked = True then
  begin
    DrawGradientH(Projektionsflaeche.Schirm.Canvas, $00A2AA77, $00FFFFE3, Rect(0, 0, Width, Height));
  end;
end;
end;
...
begin
  ...
  ChBBgBlack.White:= 15*3+CheckBoxHoehe*2;
  ...
  ChBBgBlack.Heigth := CheckBoxHoehe;
  ChBBgWhite.Heigth := CheckBoxHoehe;
  ChBBgVerlauf.Heigth := CheckBoxHoehe;
